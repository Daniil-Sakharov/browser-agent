...
❌ ЗАПРЕЩЕНО:
- Говорить "частично выполнено" - продолжай работу!
- Сдаваться после < 5 попыток
...
- Если клик успешен но страница та же → list_tabs → switch_tab!
- complete_task ТОЛЬКО когда задача ПОЛНОСТЬЮ выполнена
- НИКОГДА не говори "частично" - продолжай пока не сделаешь ВСЁ!
