	...
	return []Rule{
		{
			...
			Matcher: func(a domain.Action, c *domain.PageContext) bool {
				if !isClickAction(a) || c == nil { return false }
		...
		},
		{
			...
			Matcher: func(a domain.Action, c *domain.PageContext) bool {
				if a.Type != domain.ActionTypeClick || c == nil { return false }
		...
		},
		{
			...
			Matcher: func(a domain.Action, c *domain.PageContext) bool {
				if !isClickAction(a) { return false }
		...
		},
		{
			...
			Matcher: func(a domain.Action, c *domain.PageContext) bool {
				if a.Type != domain.ActionTypeClick && a.Type != domain.ActionTypeType { return false }
